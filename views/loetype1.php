    ...
    <tr>
        <td bgcolor="#f9f9f9">
            <table border="0" cellpadding="0" cellspacing="0" width="300">
                <tbody><tr>
                    <td vertical-align="top" ;="" height="93" width="300">
                        <table style="margin-top:0px; margin-left:0px" height="93px" border="0" cellpadding="0" cellspacing="0" width="300px"><tbody>
                            <tr>
                                <td style="vertical-align: top;" ;="" height="93" width="100">
                                ...
                                <td style="vertical-align: top" width="34">
                                    <table style="table-layout:fixed; margin-top:0px; margin-left:0px;" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="34"><tbody>
                                        <tr style="vertical-align: baseline;">
                                            <td style="width: 34px; height: 93px" height="93" align="left">
                                                <img alt="loe" src="http://informacion.quebuenacompra.com/qbc-design/news-loe/images/News_pauta_04.jpg"></td>
                                        </tr>
                                        </tbody></table>
                                </td>
                                <td style="vertical-align: top;" ;="" width="166">
                                    <table style=" margin-top:0px; margin-left:0px;" height="93" border="0" cellpadding="0" cellspacing="0" width="166"><tbody>
                                        <tr>
