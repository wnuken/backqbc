...
/**
 * Base class that represents a row from the 'personalized_coupons' table.
 *
 *
 *
 * @package    propel.generator.atmadmin.om
 */
abstract class BasePersonalizedCoupons extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PersonalizedCouponsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PersonalizedCouponsPeer
     */
    ...
    /**
     * Initializes internal state of BasePersonalizedCoupons object.
     * @see        applyDefaults()
     */
     ...
     * @return PersonalizedCoupons The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PersonalizedCouponsPeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = PersonalizedCouponsPeer::CODE;
        }
    ...
    public function setGroupdealsId($v)
    {
        ...
        if ($this->groupdeals_id !== $v) {
            ...
            $this->modifiedColumns[] = PersonalizedCouponsPeer::GROUPDEALS_ID;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = PersonalizedCouponsPeer::STATUS;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersonalizedCouponsPeer::CREATED_AT;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->groupdeals_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 5; // 5 = PersonalizedCouponsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PersonalizedCoupons object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PersonalizedCouponsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PersonalizedCouponsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PersonalizedCouponsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->couponMappingsScheduledForDeletion !== null) {
                if (!$this->couponMappingsScheduledForDeletion->isEmpty()) {
                    foreach ($this->couponMappingsScheduledForDeletion as $couponMapping) {
                        // need to save related object because we set the relation to null
                        $couponMapping->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PersonalizedCouponsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PersonalizedCouponsPeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(PersonalizedCouponsPeer::GROUPDEALS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'groupdeals_id';
        }
        if ($this->isColumnModified(PersonalizedCouponsPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(PersonalizedCouponsPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO personalized_coupons (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PersonalizedCouponsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PersonalizedCouponsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PersonalizedCoupons'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PersonalizedCoupons'][$this->getPrimaryKey()] = true;
        $keys = PersonalizedCouponsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getGroupdealsId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setGroupdealsId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersonalizedCouponsPeer::ID)) $criteria->add(PersonalizedCouponsPeer::ID, $this->id);
        if ($this->isColumnModified(PersonalizedCouponsPeer::CODE)) $criteria->add(PersonalizedCouponsPeer::CODE, $this->code);
        if ($this->isColumnModified(PersonalizedCouponsPeer::GROUPDEALS_ID)) $criteria->add(PersonalizedCouponsPeer::GROUPDEALS_ID, $this->groupdeals_id);
        if ($this->isColumnModified(PersonalizedCouponsPeer::STATUS)) $criteria->add(PersonalizedCouponsPeer::STATUS, $this->status);
        if ($this->isColumnModified(PersonalizedCouponsPeer::CREATED_AT)) $criteria->add(PersonalizedCouponsPeer::CREATED_AT, $this->created_at);
    ...
    {
        $criteria = new Criteria(PersonalizedCouponsPeer::DATABASE_NAME);
        $criteria->add(PersonalizedCouponsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PersonalizedCoupons (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setGroupdealsId($this->getGroupdealsId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PersonalizedCoupons Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PersonalizedCouponsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PersonalizedCouponsPeer();
        }
     ...
     * If this PersonalizedCoupons is new, it will return
        ...
        if (null === $this->collCouponMappings || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCouponMappings) {
                ...
                $collCouponMappings = CouponMappingQuery::create(null, $criteria)
                    ->filterByPersonalizedCoupons($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setCouponMappings(PropelCollection $couponMappings, PropelPDO $con = null)
    {
        ...
        foreach ($couponMappingsToDelete as $couponMappingRemoved) {
            $couponMappingRemoved->setPersonalizedCoupons(null);
        }
    ...
    protected function doAddCouponMapping($couponMapping)
    {
        ...
        $couponMapping->setPersonalizedCoupons($this);
    }
    ...
    public function removeCouponMapping($couponMapping)
    {
        if ($this->getCouponMappings()->contains($couponMapping)) {
            ...
            $couponMapping->setPersonalizedCoupons(null);
        }
     ...
     * Otherwise if this PersonalizedCoupons is new, it will return
     * an empty collection; or if this PersonalizedCoupons has previously
     * been saved, it will retrieve related CouponMappings from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PersonalizedCoupons.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|CouponMapping[] List of CouponMapping objects
     */
    public function getCouponMappingsJoinSalesFlatOrder($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CouponMappingQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(PersonalizedCouponsPeer::DEFAULT_STRING_FORMAT);
    }
