...
abstract class BaseGroupdealsPeer
{
    ...
    /** the column name for the general_nit field */
    const GENERAL_NIT = 'groupdeals.general_nit';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupdealsPeer::GENERAL_NIT);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.general_nit');
        }
    }
