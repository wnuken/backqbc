...
/**
 * This class defines the structure of the 'qbc_sci_credit_construct_doc' table.
 *
 *
 *
 ...
 */
class QbcSciCreditConstructDocTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'atmadmin.map.QbcSciCreditConstructDocTableMap';
    ...
    {
        // attributes
        $this->setName('qbc_sci_credit_construct_doc');
        $this->setPhpName('QbcSciCreditConstructDoc');
        $this->setClassname('QbcSciCreditConstructDoc');
...
} // QbcSciCreditConstructDocTableMap
