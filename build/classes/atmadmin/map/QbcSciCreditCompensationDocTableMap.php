...
/**
 * This class defines the structure of the 'qbc_sci_credit_compensation_doc' table.
 *
 *
 *
 ...
 */
class QbcSciCreditCompensationDocTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'atmadmin.map.QbcSciCreditCompensationDocTableMap';
    ...
    {
        // attributes
        $this->setName('qbc_sci_credit_compensation_doc');
        $this->setPhpName('QbcSciCreditCompensationDoc');
        $this->setClassname('QbcSciCreditCompensationDoc');
...
} // QbcSciCreditCompensationDocTableMap
