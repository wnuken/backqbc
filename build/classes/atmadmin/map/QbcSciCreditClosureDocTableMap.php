...
/**
 * This class defines the structure of the 'qbc_sci_credit_closure_doc' table.
 *
 *
 *
 ...
 */
class QbcSciCreditClosureDocTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'atmadmin.map.QbcSciCreditClosureDocTableMap';
    ...
    {
        // attributes
        $this->setName('qbc_sci_credit_closure_doc');
        $this->setPhpName('QbcSciCreditClosureDoc');
        $this->setClassname('QbcSciCreditClosureDoc');
        $this->setPackage('atmadmin');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, 10, null);
        $this->addColumn('petition_Id', 'PetitionId', 'VARCHAR', false, 10, null);
...
} // QbcSciCreditClosureDocTableMap
