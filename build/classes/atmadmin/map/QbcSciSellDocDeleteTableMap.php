...
/**
 * This class defines the structure of the 'qbc_sci_sell_doc_delete' table.
 *
 *
 *
 ...
 */
class QbcSciSellDocDeleteTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'atmadmin.map.QbcSciSellDocDeleteTableMap';
    ...
    {
        // attributes
        $this->setName('qbc_sci_sell_doc_delete');
        $this->setPhpName('QbcSciSellDocDelete');
        $this->setClassname('QbcSciSellDocDelete');
