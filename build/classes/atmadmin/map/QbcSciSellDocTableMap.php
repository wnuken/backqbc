...
/**
 * This class defines the structure of the 'qbc_sci_sell_doc' table.
 *
 *
 *
 ...
 */
class QbcSciSellDocTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'atmadmin.map.QbcSciSellDocTableMap';
    ...
    {
        // attributes
        $this->setName('qbc_sci_sell_doc');
        $this->setPhpName('QbcSciSellDoc');
        $this->setClassname('QbcSciSellDoc');
